...
const customTheme = {
  ...
  badge: {
    root: {
      ...
      color: {
        ...
        muted: "bg-lightbg dark:bg-darkbody text-dark dark:text-white",
        lightmuted: "bg-lightbg dark:bg-darkbody text-dark dark:text-white",
        lightsubtle: " text-dark dark:text-darkmuted",
        lightgray: "bg-white dark:bg-darkgray text-dark dark:text-white",
      },
    },
    icon: {
  ...
  card: {
    root: {
      base: "flex rounded-md dark:shadow-dark-md shadow-md bg-white dark:bg-darkgray p-6 mb-0",
  ...
  Dropdown: {
    content: "py-2",
    floating: {
      base: "z-10 w-fit rounded-md items-center focus:outline-none shadow-md dark:shadow-dark-md",
      content: "py-2 text-sm text-darklink ",
      header:
        "block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 items-center",
      item: {
  ...
  table: {
    ...
    head: {
      base: "group/head text-sm font-medium capitalize text-dark dark:text-darklink border-0",
      cell: {
        base: "font-semibold p-4 dark:bg-transparent",
      },
    },
    body: {
      base: "group/body",
      cell: {
        base: "px-4 p-4 dark:bg-transparent",
      },
    },
    row: {
  ...
  accordion: {
    root: {
      base: "divide-y divide-border dark:divide-darkborder bg-white dark:bg-darkgray",
      flush: {
  ...
  tabs: {
    base: "flex flex-col gap-2 font-medium ",
    tablist: {
      ...
      tabitem: {
        base: "flex items-center gap-2 font-medium justify-center rounded-t-lg p-4 text-sm  first:ml-0 focus:outline-none focus:ring-0 disabled:cursor-not-allowed disabled:text-gray-400 disabled:dark:text-gray-500",
        variant: {
          default: {
            base: "rounded-t-md",
            active: {
  ...
  navbar: {
    ...
    link: {
      base: "text-base py-1.5 px-4 hover:text-primary dark:hover:text-primary hover:bg-lightprimary font-medium rounded-full flex justify-center items-center cursor-pointer ",
      active: {
        on: "bg-lightprimary text-white dark:text-darkbody",
        off: "text-darkbody dark:text-darkmuted",
      },
    },
  },
  ...
  carousel: {
    ...
    indicators: {
      active: {
        off: "bg-lightbg dark:bg-darkbody",
    ...
    control: {
      base: "inline-flex sm:h-10 sm:w-10 h-0 w-0 items-center justify-center rounded-full bg-white dark:bg-darkmuted hover:bg-primary hover:text-white  group-hover:bg-primary group-focus:outline-none group-focus:ring-0",
  ...
  sidebar: {
    ...
    item: {
      base: "flex items-center justify-center rounded-sm mb-0.5 text-sm leading-[normal] font-light text-white text-opacity-60 mt-0 hover:text-white hover:text-opacity-100 dark:text-white dark:text-opacity-60  dark:hover:text-white",
      content: {
        base: "flex-1 whitespace-nowrap px-0",
      },
      active:
        "text-white text-opacity-100 font-medium dark:text-white dark:text-opacity-100",
    },
    collapse: {
      button:
        "group flex items-center hide-menu-level justify-center rounded-lg mb-0.5 text-sm leading-[normal] text-opacity-60 font-light text-white  hover:text-white hover:text-opacity-100 dark:text-white dark:text-opacity-60 w-full dark:hover:text-white dark:hover:text-opacity-100",
      icon: {
        base: "h-6 w-6 text-base",
      },
    },
    label: {
