  ...
  return (
    <>
      <div className="flex justify-between gap-8 my-6 ">
        <Link
          href={"/"}
          className="px-4 py-2.5 border-muted border dark:border-darkborder flex gap-2 items-enter w-full rounded-md text-center justify-center text-dark dark:text-white text-primary-ld"
        >
