  ...
  return (
    <>
      <div className="relative group ">
        ...
        <div className="sm:w-[900px] w-screen dropdown megamenu invisible  group-hover:visible absolute z-[10]">
          <Drawer
            open={isOpen}
            onClose={handleClose}
            position="right"
            className="xl:relative xl:transform-none xl:h-auto xl:bg-transparent xl:z-[0] xl:w-[900px] w-64 dark:bg-darkgray"
          >
                      ...
                      >
                        <ul>
                          <li>
                            ...
                            >
                              <span className="bg-lightsecondary dark:bg-lightprimary  h-10 w-10 flex justify-center items-center rounded-full">
                                <Image
                                  src={links.avatar}
                                  width={20}
                                  height={20}
