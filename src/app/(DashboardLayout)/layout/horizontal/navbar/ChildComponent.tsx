            ...
            <Link href={item.href}>
                <p
                    className={`w-full ${item.href === pathname
                        ...
                        } py-1 px-3 rounded-full flex gap-3 dark:text-subtlewhite items-center text-ld opacity-80 hover:text-primary`}
                >
                            ...
                            <li key={child.id}>
                                {child.children ? (
                                    ...
                                    <Link href={child.href}>
                                        <p className={` hover:text-primary ${child.href == pathname
                                            ? "!text-primary "
                                            : 'group-hover/nav:bg-lightprimary group-hover/nav:text-primary'
...
//                             <li key={child.id}>
//                                 <Link href={child.href}>
//                                     <p className={`hover:text-primary ${child.href === pathname ? 'text-primary' : 'group-hover/nav:bg-lightprimary group-hover/nav:text-primary'} py-1 px-3 rounded-full flex gap-2 items-center text-ld opacity-80`}>
